...
abstract class Customer {
    ...
    long PhoneNumber;
    double billamount;
    public Customer(int customerId,String customerName,long phoneNumber,double billamount)
    {
    	super();
  ...
  {
	  double Discount;
	  public RegularCustomer(int customerId,String customerName,long phoneNumber,double billamount)
	  {
    ...
    class Privilegedcustomer extends Customer
    {
      ...
      public Privilegedcustomer(int customerId,String customerName,long phoneNumber,double billamount,String membercardType){
    	    super(customerId,customerName,phoneNumber,billamount);
